package com.johnrony.cinemaapp
...
class MovieDetail : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.johnrony.cinemaapp.R.layout.activity_movie_detail)
        ...
        titleTextView = findViewById(com.johnrony.cinemaapp.R.id.titleTextView)
        movieImageView = findViewById(com.johnrony.cinemaapp.R.id.movieImageView)
        plotTextView = findViewById(com.johnrony.cinemaapp.R.id.plotTextView)
        date1TextView = findViewById(com.johnrony.cinemaapp.R.id.date1TextView)
        jour1TextView = findViewById(com.johnrony.cinemaapp.R.id.jour1TextView)
        date2TextView = findViewById(com.johnrony.cinemaapp.R.id.date2TextView)
        date3TextView = findViewById(com.johnrony.cinemaapp.R.id.date3TextView)
        date4TextView = findViewById(com.johnrony.cinemaapp.R.id.date4TextView)
        date5TextView = findViewById(com.johnrony.cinemaapp.R.id.date5TextView)
        jour2TextView = findViewById(com.johnrony.cinemaapp.R.id.jour2TextView)
        jour3TextView = findViewById(com.johnrony.cinemaapp.R.id.jour3TextView)
        jour4TextView = findViewById(com.johnrony.cinemaapp.R.id.jour4TextView)
        jour5TextView = findViewById(com.johnrony.cinemaapp.R.id.jour5TextView)
        h1TextView = findViewById(com.johnrony.cinemaapp.R.id.h1TextView)
        h2TextView = findViewById(com.johnrony.cinemaapp.R.id.h2TextView)
        h3TextView = findViewById(com.johnrony.cinemaapp.R.id.h3TextView)
        h4TextView = findViewById(com.johnrony.cinemaapp.R.id.h4TextView)
        h5TextView = findViewById(com.johnrony.cinemaapp.R.id.h5TextView)
        h6TextView = findViewById(com.johnrony.cinemaapp.R.id.h6TextView)
        h7TextView = findViewById(com.johnrony.cinemaapp.R.id.h7TextView)
        h8TextView = findViewById(com.johnrony.cinemaapp.R.id.h8TextView)
        h9TextView = findViewById(com.johnrony.cinemaapp.R.id.h9TextView)
        reserveButton = findViewById(com.johnrony.cinemaapp.R.id.reserveButton)
        choixDates()
        choixHeures()
        ...
        titleTextView?.setText(intent.getStringExtra("title"))
            ...
            FirebaseFirestore.getInstance().collection("movies")
                .document(titleTextView?.getText().toString()).addSnapshotListener { value, error ->
                    val poster = value!!["poster"].toString()
                    Log.i("posterTAG", poster)
                    Picasso.get().load(poster).into(movieImageView)
                    val plot = value["plot"].toString()
